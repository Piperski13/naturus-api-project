...
const tourRouter = express.Router(); //created a new router and saved it in tourRouter
const userRouter = express.Router(); //created a new router and saved it in userRouter
